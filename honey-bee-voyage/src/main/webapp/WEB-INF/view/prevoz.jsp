...
<body class="pozadina">
	...
	<div class="row">
			...
			<table class="table table-striped">
				<thead>
					<tr>
						...
						<th scope="col">Novo vozilo</th>
					</tr>
				</thead>
				<tbody>
				<c:forEach var="temp" items="${prevoz}">
					<tr>
						<td>${temp.getIdPrevoznika()}</td>
						<td>${temp.getNaziv()}</td>
						<td>${temp.getOpis()}</td>
						<td><a href="${pageContext.request.contextPath }/novo-vozilo-${temp.getIdPrevoznika()}">Dodaj</a></td>
					</tr>
				</c:forEach>
				</tbody>
			</table>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<a href="${pageContext.request.contextPath }/prevoz-forma" class="dugme">Dodaj</a>
			</div>
		</div>
