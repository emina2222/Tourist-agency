...
<body class="pozadina">
	...
	<div class="row">
		...
		<div class="row">
			<div class="col-md-12 centar">
				<h1>${aranzman.naziv}</h1>
				<p>Grupa: ${grupa}</p>
			</div>
		</div>
			<div class="row">
				<div class="col-md-12 centar">
					<a href="${pageContext.request.contextPath }/unos-ponude-prevoznika-${aranzman.idAranzmana}" class="dugme">Unos ponude prevoznika</a>
				</div>
			</div>
			<br>
			<br>
			<div class="row">
				<div class="col-md-12 centar">
					<a href="${pageContext.request.contextPath }/unos-destinacije-${aranzman.idAranzmana}" class="dugme">Unos destinacije</a>
				</div>
			</div>
			<br>
			<br>
			<div class="row">
				<div class="col-md-12 centar">
					<a
						href="${pageContext.request.contextPath }/unos-angazovanja-${aranzman.idAranzmana}"
						class="dugme">Unos angažovanja turističkih
						vodiča</a>
			</div>
			</div>
			<br>
			<br>
			<c:if test="${grupa==1 || grupa==2}">
			<div class="row">
				<div class="col-md-12 centar">
					<a href="${pageContext.request.contextPath }/unos-ponude-smestaja-${aranzman.idAranzmana}" class="dugme">Unos ponude smeštaja</a>
					<a href="${pageContext.request.contextPath }/unos-smestajnih-jca-${aranzman.idAranzmana}" class="dugme">Unos smeštajnih jedinica</a>
					<a href="${pageContext.request.contextPath }/unos-stavki-smestaja-${aranzman.idAranzmana}" class="dugme">Unos stavke smeštaja</a>
				</div>
			</div>
			</c:if>
