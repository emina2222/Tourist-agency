		...
		<div class="row">
			...
			<div class="col-md-6">
				<form:form class="well form-horizontal"
					action="${pageContext.request.contextPath }/sacuvajFormuJedinice" method="POST">
					<input type="hidden" name="idAranzmana" value="${idAranzmana}"/>
					
					<label>Izaberi smeštaj:</label>
					...
					<p>
						Broj sobe (ID) *: <input name="brojSobe" class="form-control" type="text" required/>
					</p>

					<p>
						Broj kreveta *: <input name="kreveti" class="form-control" type="number" required/>
					</p>
