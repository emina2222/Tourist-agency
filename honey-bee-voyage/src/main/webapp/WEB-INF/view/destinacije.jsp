...
<body class="pozadina">
	...
	<div class="row">
			...
			<table class="table table-striped">
				<thead>
					<tr>
						...
						<th scope="col">Atrakcije</th>
						<th scope="col">Fakul. izleti</th>
						<th scope="col">Obriši sa aranžmana</th>
					</tr>
				</thead>
				<tbody>
				<c:forEach var="temp" items="${destinacije}">
					<tr>
						<td>${temp.getIdDestinacije()}</td>
						<td>${temp.getLokacija()}</td>
						<td>${temp.getDrzava()}</td>
						<td>${temp.getOpis()}</td>
						<td><a href="${pageContext.request.contextPath }/atrakcije-${temp.getIdDestinacije()}">Dodaj</a></td>
						<td><a href="${pageContext.request.contextPath }/izleti-${temp.getIdDestinacije()}">Dodaj</a></td>
						<td><a href="${pageContext.request.contextPath }/brisanje-dest-${temp.getIdDestinacije()}">Obriši</a></td>
					</tr>
				</c:forEach>
				</tbody>
			</table>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<a href="${pageContext.request.contextPath }/destinacije-forma" class="dugme">Dodaj</a>
			</div>
		</div>
