		...
		<div class="row">
			...
			<div class="col-md-8 centar">
				<form:form class="well form-horizontal"
					action="${pageContext.request.contextPath }/processOneDayTripReservation"
					method="POST">
					...
					<input type="hidden" id="cenaTure" value="${cena}"/>
					...
					<p class="stavke">Datum polaska: ${datumIzleta}</p>
					<p class="stavke">Cena aranžmana: ${cena} RSD</p>
